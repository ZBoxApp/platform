...
export default {
    ...
    ZBOXNOW_ICON_SVG: "<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 125.01 148.02'><defs><style>.a{fill:#ff5d23;}.a,.b,.c,.d,.e,.f,.g,.h{fill-rule:evenodd;}.b{fill:#98e427;}.c{fill:#ffbf01;}.d{fill:#1caaa3;}.e{fill:#ffdf81;}.f{fill:#e84810;}.g{fill:#8ccd1a;}.h{fill:#2cd6d2;}</style></defs><title>now</title><path class='a' d='M540.26,318H478.82V301.91h96.73L478.82,416.44V392.57C499.57,367.52,519.44,343.17,540.26,318Z' transform='translate(-478.82 -275.99)'/><path class='b' d='M603.83,283.56v23.88c-20.75,25.05-40.62,49.4-61.44,74.54h61.44v16.12H507.1Z' transform='translate(-478.82 -275.99)'/><polygon class='c' points='0 0 118.61 0 105 16.13 0 16.13 0 0'/><polygon class='d' points='125.01 148.02 6.39 148.02 20.01 131.9 125.01 131.9 125.01 148.02'/><polygon class='e' points='0 16.13 118.61 0 0 0 0 16.13'/><polygon class='f' points='0 42.05 96.73 25.92 0 116.58 61.44 42.04 0 42.05'/><polygon class='g' points='125.01 31.45 28.28 122.1 125.01 105.98 63.57 105.98 125.01 31.45'/><polygon class='h' points='20.01 131.9 125.01 148.02 6.39 148.02 20.01 131.9'/></svg>",
