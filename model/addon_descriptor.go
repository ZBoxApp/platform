...
type AddonDescriptorCommand struct {
...
type AddonDescriptor struct {
	...
	Webhooks    AddonDescriptorWebhook     `json:"webhook"`
	Compacts    []AddonDescriptorCompact   `json:"compact"`
	Webpanels   []AddonDescriptorWebPanel  `json:"webPanel"`
	Dialogs     []AddonDescriptorDialog    `json:"dialog"`
	Actions     []AddonDescriptorAction    `json:"action"`
	Commands    []AddonDescriptorCommand   `json:"commands"`
}
